...
REM  either the CPU or Memory/RAM threshold values
REM Scheduled to run hourly
...
:ProcessDriveInfo
  ...
  IF %procFreeSpace% LEQ %lowThresholdDrive% (
    REM Commented line below for Hourly Monitoring
    REM SET ERRORFLAG=1
...
:CreateEmail
  ...
  REM Email Subject
  ECHO ALERT -- Windows %myHostName% -- Hourly Server Monitoring >> "%tempDir%\email_subj.txt"
